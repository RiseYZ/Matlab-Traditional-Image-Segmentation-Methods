function [avg_dice, avg_iou] = unet_evaluate()
    % 
    ...
    for i = 1:num_files
        ...
        label_file = ['Y', pred_files(i).name(2:end)];
        true_mask = imread(fullfile(true_folder, label_file));
